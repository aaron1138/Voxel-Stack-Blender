...
class XYBlendTab(QWidget):
    ...
    def _create_parameter_widgets(self):
        ...
        self.gaussian_ksize_x_edit = QLineEdit("3"); self.gaussian_ksize_x_edit.setFixedWidth(60); self.gaussian_ksize_x_edit.setValidator(QIntValidator(1, 99, self))
        ksize_layout.addWidget(self.gaussian_ksize_x_edit)
        self.gaussian_ksize_y_edit = QLineEdit("3"); self.gaussian_ksize_y_edit.setFixedWidth(60); self.gaussian_ksize_y_edit.setValidator(QIntValidator(1, 99, self))
        ...
        self.gaussian_sigma_x_edit = QLineEdit("0"); self.gaussian_sigma_x_edit.setFixedWidth(60); self.gaussian_sigma_x_edit.setValidator(QDoubleValidator(0.0, 100.0, 2, self))
        sigma_layout.addWidget(self.gaussian_sigma_x_edit)
        self.gaussian_sigma_y_edit = QLineEdit("0"); self.gaussian_sigma_y_edit.setFixedWidth(60); self.gaussian_sigma_y_edit.setValidator(QDoubleValidator(0.0, 100.0, 2, self))
        ...
        layout.addWidget(QLabel("Diameter:")); self.bilateral_d_edit = QLineEdit("9"); self.bilateral_d_edit.setFixedWidth(60); self.bilateral_d_edit.setValidator(QIntValidator(1, 99, self)); layout.addWidget(self.bilateral_d_edit)
        layout.addWidget(QLabel("Sigma Color:")); self.bilateral_sigma_color_edit = QLineEdit("75"); self.bilateral_sigma_color_edit.setFixedWidth(60); self.bilateral_sigma_color_edit.setValidator(QDoubleValidator(0.0, 255.0, 2, self)); layout.addWidget(self.bilateral_sigma_color_edit)
        layout.addWidget(QLabel("Sigma Space:")); self.bilateral_sigma_space_edit = QLineEdit("75"); self.bilateral_sigma_space_edit.setFixedWidth(60); self.bilateral_sigma_space_edit.setValidator(QDoubleValidator(0.0, 255.0, 2, self)); layout.addWidget(self.bilateral_sigma_space_edit)
        layout.addStretch(1)
        self.op_params_stacked_widget.addWidget(self.bilateral_params_widget)

        # --- Median Blur ---
        self.median_params_widget = QWidget(); layout = QVBoxLayout(self.median_params_widget)
        layout.addWidget(QLabel("Kernel Size:")); self.median_ksize_edit = QLineEdit("5"); self.median_ksize_edit.setFixedWidth(60); self.median_ksize_edit.setValidator(QIntValidator(1, 99, self)); layout.addWidget(self.median_ksize_edit)
        layout.addStretch(1)
        self.op_params_stacked_widget.addWidget(self.median_params_widget)

        # --- Unsharp Mask ---
        self.unsharp_params_widget = QWidget(); layout = QVBoxLayout(self.unsharp_params_widget)
        layout.addWidget(QLabel("Amount:")); self.unsharp_amount_edit = QLineEdit("1.0"); self.unsharp_amount_edit.setFixedWidth(60); self.unsharp_amount_edit.setValidator(QDoubleValidator(0.0, 5.0, 2, self)); layout.addWidget(self.unsharp_amount_edit)
        layout.addWidget(QLabel("Threshold:")); self.unsharp_threshold_edit = QLineEdit("0"); self.unsharp_threshold_edit.setFixedWidth(60); self.unsharp_threshold_edit.setValidator(QIntValidator(0, 255, self)); layout.addWidget(self.unsharp_threshold_edit)
        layout.addWidget(QLabel("Internal Blur KSize:")); self.unsharp_blur_ksize_edit = QLineEdit("5"); self.unsharp_blur_ksize_edit.setFixedWidth(60); self.unsharp_blur_ksize_edit.setValidator(QIntValidator(1, 99, self)); layout.addWidget(self.unsharp_blur_ksize_edit)
        layout.addWidget(QLabel("Internal Blur Sigma:")); self.unsharp_blur_sigma_edit = QLineEdit("0"); self.unsharp_blur_sigma_edit.setFixedWidth(60); self.unsharp_blur_sigma_edit.setValidator(QDoubleValidator(0.0, 100.0, 2, self)); layout.addWidget(self.unsharp_blur_sigma_edit)
        layout.addStretch(1)
        self.op_params_stacked_widget.addWidget(self.unsharp_params_widget)

        # --- Resize ---
        self.resize_params_widget = QWidget(); layout = QVBoxLayout(self.resize_params_widget)
        layout.addWidget(QLabel("Width (px, 0 for auto):")); self.resize_width_edit = QLineEdit("0"); self.resize_width_edit.setFixedWidth(80); self.resize_width_edit.setValidator(QIntValidator(0, 99999, self)); layout.addWidget(self.resize_width_edit)
        layout.addWidget(QLabel("Height (px, 0 for auto):")); self.resize_height_edit = QLineEdit("0"); self.resize_height_edit.setFixedWidth(80); self.resize_height_edit.setValidator(QIntValidator(0, 99999, self)); layout.addWidget(self.resize_height_edit)
        layout.addWidget(QLabel("Resampling Mode:")); self.resample_mode_combo = QComboBox(); self.resample_mode_combo.addItems(["NEAREST", "BILINEAR", "BICUBIC", "LANCZOS4", "AREA"]); layout.addWidget(self.resample_mode_combo)
        layout.addStretch(1)
    ...
    def _connect_signals(self):
        ...
        self.gaussian_anisotropic_checkbox.clicked.connect(lambda checked: self._update_param_in_config(self.gaussian_anisotropic_checkbox, "enable_anisotropic_correction", bool, use_checked=True))
        ...
        self.bilateral_anisotropic_checkbox.clicked.connect(lambda checked: self._update_param_in_config(self.bilateral_anisotropic_checkbox, "enable_anisotropic_correction", bool, use_checked=True))
    ...
    def _populate_params_widgets(self, op: XYBlendOperation):
        ...
        self.gaussian_anisotropic_checkbox.setChecked(op.enable_anisotropic_correction)
        ...
        self.bilateral_anisotropic_checkbox.setChecked(op.enable_anisotropic_correction)
    ...
    def _update_param_in_config(self, sender_widget, param_name: str, data_type: type, allow_none_if_zero: bool = False, use_checked: bool = False):
        current_row = self.ops_list_widget.currentRow()
        ...
        try:
            ...
            if hasattr(sender_widget, 'setStyleSheet'):
