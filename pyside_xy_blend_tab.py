...
class XYBlendTab(QWidget):
    ...
    def _create_parameter_widgets(self):
        ...
        self.gaussian_sigma_x_edit = QLineEdit("0.0"); self.gaussian_sigma_x_edit.setFixedWidth(60); self.gaussian_sigma_x_edit.setValidator(QDoubleValidator(0.0, 100.0, 2, self))
        sigma_layout.addWidget(self.gaussian_sigma_x_edit)
        self.gaussian_sigma_y_edit = QLineEdit("0.0"); self.gaussian_sigma_y_edit.setFixedWidth(60); self.gaussian_sigma_y_edit.setValidator(QDoubleValidator(0.0, 100.0, 2, self))
        ...
        self.bilateral_d_edit = QLineEdit("9"); self.bilateral_d_edit.setFixedWidth(60); self.bilateral_d_edit.setValidator(QIntValidator(1, 99, self))
        layout.addWidget(self.bilateral_d_edit)
        layout.addWidget(QLabel("Sigma Color:"))
        self.bilateral_sigma_color_edit = QLineEdit("75.0"); self.bilateral_sigma_color_edit.setFixedWidth(60); self.bilateral_sigma_color_edit.setValidator(QDoubleValidator(0.0, 255.0, 2, self))
        layout.addWidget(self.bilateral_sigma_color_edit)
        layout.addWidget(QLabel("Sigma Space:"))
        self.bilateral_sigma_space_edit = QLineEdit("75.0"); self.bilateral_sigma_space_edit.setFixedWidth(60); self.bilateral_sigma_space_edit.setValidator(QDoubleValidator(0.0, 255.0, 2, self))
        ...
        self.median_ksize_edit = QLineEdit("5"); self.median_ksize_edit.setFixedWidth(60); self.median_ksize_edit.setValidator(QIntValidator(1, 99, self))
        ...
        self.unsharp_amount_edit = QLineEdit("1.0"); self.unsharp_amount_edit.setFixedWidth(60); self.unsharp_amount_edit.setValidator(QDoubleValidator(0.0, 5.0, 2, self))
        layout.addWidget(self.unsharp_amount_edit)
        layout.addWidget(QLabel("Threshold:"))
        self.unsharp_threshold_edit = QLineEdit("0"); self.unsharp_threshold_edit.setFixedWidth(60); self.unsharp_threshold_edit.setValidator(QIntValidator(0, 255, self))
        layout.addWidget(self.unsharp_threshold_edit)
        layout.addWidget(QLabel("Internal Blur KSize:"))
        self.unsharp_blur_ksize_edit = QLineEdit("5"); self.unsharp_blur_ksize_edit.setFixedWidth(60); self.unsharp_blur_ksize_edit.setValidator(QIntValidator(1, 99, self))
        layout.addWidget(self.unsharp_blur_ksize_edit)
        layout.addWidget(QLabel("Internal Blur Sigma:"))
        self.unsharp_blur_sigma_edit = QLineEdit("0.0"); self.unsharp_blur_sigma_edit.setFixedWidth(60); self.unsharp_blur_sigma_edit.setValidator(QDoubleValidator(0.0, 100.0, 2, self))
        ...
        self.resize_width_edit = QLineEdit("0"); self.resize_width_edit.setFixedWidth(80); self.resize_width_edit.setValidator(QIntValidator(0, 9999, self))
        layout.addWidget(self.resize_width_edit)
        layout.addWidget(QLabel("Height (px, 0 for auto):"))
        self.resize_height_edit = QLineEdit("0"); self.resize_height_edit.setFixedWidth(80); self.resize_height_edit.setValidator(QIntValidator(0, 9999, self))
    ...
    def _connect_signals(self):
        ...
        if hasattr(self, 'gaussian_anisotropic_checkbox'):
            self.gaussian_anisotropic_checkbox.toggled.connect(lambda state: setattr(self.config.xy_blend_pipeline[self.ops_list_widget.currentRow()], 'anisotropic_correction_enabled', bool(state)) if 0 <= self.ops_list_widget.currentRow() < len(self.config.xy_blend_pipeline) else None)
        if hasattr(self, 'bilateral_anisotropic_checkbox'):
            self.bilateral_anisotropic_checkbox.toggled.connect(lambda state: setattr(self.config.xy_blend_pipeline[self.ops_list_widget.currentRow()], 'anisotropic_correction_enabled', bool(state)) if 0 <= self.ops_list_widget.currentRow() < len(self.config.xy_blend_pipeline) else None)
