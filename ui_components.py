...
class ImageProcessorApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.sparse_checkbox.setToolTip("Loads the entire image stack into RAM using a sparse array for faster processing, especially for XZ/YZ operations. Requires more RAM.")
    ...
    def load_settings(self):
        ...
        self.sparse_checkbox.setChecked(config.load_sparse)
    ...
    def save_settings(self):
        ...
        config.load_sparse = self.sparse_checkbox.isChecked()
