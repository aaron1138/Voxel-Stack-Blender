...
class ImageProcessorApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.sparse_array_checkbox.setToolTip("Loads the entire image stack into a sparse memory array. Improves performance for XZ/YZ operations at the cost of higher RAM usage.")
