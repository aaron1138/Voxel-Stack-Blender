...
class ImageProcessorApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.sparse_array_checkbox = QCheckBox("Load full stack as sparse array to RAM")
        self.sparse_array_checkbox.setToolTip("Loads the entire image stack into a memory-efficient sparse array. Required for Z/Y-plane operations and can improve performance on fast storage.")
        general_layout.addWidget(self.sparse_array_checkbox)
    ...
    def load_settings(self):
        ...
        self.sparse_array_checkbox.setChecked(config.use_sparse_array)
    ...
    def save_settings(self):
        ...
        config.use_sparse_array = self.sparse_array_checkbox.isChecked()
