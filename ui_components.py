...
class ImageProcessorApp(QWidget):
    ...
    def init_ui(self):
        ...
        # --- Voxel Dimensions Section ---
        voxel_dim_group = QGroupBox("Voxel Dimensions (µm)")
        voxel_dim_layout = QHBoxLayout(voxel_dim_group)
        voxel_dim_layout.addWidget(QLabel("X:"))
        self.voxel_dim_x_edit = QLineEdit("25")
        self.voxel_dim_x_edit.setValidator(QIntValidator(1, 100, self))
        self.voxel_dim_x_edit.setFixedWidth(40)
        voxel_dim_layout.addWidget(self.voxel_dim_x_edit)
        voxel_dim_layout.addSpacing(10)
        voxel_dim_layout.addWidget(QLabel("Y:"))
        self.voxel_dim_y_edit = QLineEdit("25")
        self.voxel_dim_y_edit.setValidator(QIntValidator(1, 100, self))
        self.voxel_dim_y_edit.setFixedWidth(40)
        voxel_dim_layout.addWidget(self.voxel_dim_y_edit)
        voxel_dim_layout.addSpacing(10)
        voxel_dim_layout.addWidget(QLabel("Z:"))
        self.voxel_dim_z_edit = QLineEdit("50")
        self.voxel_dim_z_edit.setValidator(QIntValidator(1, 100, self))
        self.voxel_dim_z_edit.setFixedWidth(40)
        voxel_dim_layout.addWidget(self.voxel_dim_z_edit)
        voxel_dim_layout.addStretch(1)
        io_layout.addWidget(voxel_dim_group)
        ...
        common_blending_layout.addWidget(self.edt_anisotropic_checkbox, 2, 0, 1, 2)
    ...
    def load_settings(self):
        ...
        self.voxel_dim_x_edit.setText(str(config.voxel_dim_x))
        self.voxel_dim_y_edit.setText(str(config.voxel_dim_y))
        self.voxel_dim_z_edit.setText(str(config.voxel_dim_z))
        self.edt_anisotropic_checkbox.setChecked(config.anisotropic_flags.edt_enabled)
        ...
        self.zarr_checkbox.setChecked(config.use_zarr_pipeline)
        self.zarr_save_checkbox.setChecked(config.save_zarr_to_disk)
    ...
    def save_settings(self):
        ...
        try: config.voxel_dim_x = int(self.voxel_dim_x_edit.text())
        except ValueError: config.voxel_dim_x = 25
        try: config.voxel_dim_y = int(self.voxel_dim_y_edit.text())
        except ValueError: config.voxel_dim_y = 25
        try: config.voxel_dim_z = int(self.voxel_dim_z_edit.text())
        except ValueError: config.voxel_dim_z = 50

        config.anisotropic_flags.edt_enabled = self.edt_anisotropic_checkbox.isChecked()
        ...
        config.use_zarr_pipeline = self.zarr_checkbox.isChecked()
        config.save_zarr_to_disk = self.zarr_save_checkbox.isChecked()
