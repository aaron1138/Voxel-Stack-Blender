...
class ImageProcessorApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.sparse_checkbox = QCheckBox("Load full stack as sparse array to RAM")
        self.sparse_checkbox.setToolTip("Loads the entire image stack into a memory-efficient sparse array. This enables XZ/YZ virtual slice operations and can improve performance, but requires more RAM.")
        general_layout.addWidget(self.sparse_checkbox)
    ...
    def load_settings(self):
        ...
        self.sparse_checkbox.setChecked(config.load_as_sparse_array)
    ...
    def save_settings(self):
        ...
        config.load_as_sparse_array = self.sparse_checkbox.isChecked()
