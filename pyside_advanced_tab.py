...
class AdvancedTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.cap_layers_spin.setRange(0, 100)
        ...
        self.scale_bits_spin.setRange(8, 16)
        self.scale_bits_spin.setToolTip("Number of bits for internal fixed-point integer precision.")
        ...
        self.zarr_cache_spin.setEnabled(False)
