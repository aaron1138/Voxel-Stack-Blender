# pyside_xy_blend_tab.py (Final corrected version)
...
class XYBlendTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.lut_gamma_value_slider.setRange(1, 1000)
        ...
        self.lut_s_curve_contrast_slider.setRange(0, 100)
        ...
        self.lut_log_param_slider.setRange(1, 1000)
        ...
        self.lut_exp_param_slider.setRange(1, 1000)
        ...
        sqrt_layout.addWidget(QLabel("Param:"))
        ...
        rodbard_layout.addWidget(QLabel("Param:"))
    ...
    def _connect_signals(self):
        ...
        # Connect parameter edits to update config when editing finishes
        # We now explicitly retrieve the text from the widget since editingFinished sends no arguments.
        
        # Gaussian
        self.gaussian_ksize_x_edit.editingFinished.connect(lambda: self._update_param_in_config("gaussian_ksize_x", self.gaussian_ksize_x_edit.text(), int))
        self.gaussian_ksize_y_edit.editingFinished.connect(lambda: self._update_param_in_config("gaussian_ksize_y", self.gaussian_ksize_y_edit.text(), int))
        self.gaussian_sigma_x_edit.editingFinished.connect(lambda: self._update_param_in_config("gaussian_sigma_x", self.gaussian_sigma_x_edit.text(), float))
        self.gaussian_sigma_y_edit.editingFinished.connect(lambda: self._update_param_in_config("gaussian_sigma_y", self.gaussian_sigma_y_edit.text(), float))
        
        # Bilateral
        self.bilateral_d_edit.editingFinished.connect(lambda: self._update_param_in_config("bilateral_d", self.bilateral_d_edit.text(), int))
        self.bilateral_sigma_color_edit.editingFinished.connect(lambda: self._update_param_in_config("bilateral_sigma_color", self.bilateral_sigma_color_edit.text(), float))
        self.bilateral_sigma_space_edit.editingFinished.connect(lambda: self._update_param_in_config("bilateral_sigma_space", self.bilateral_sigma_space_edit.text(), float))

        # Median
        self.median_ksize_edit.editingFinished.connect(lambda: self._update_param_in_config("median_ksize", self.median_ksize_edit.text(), int))

        # Unsharp
        self.unsharp_amount_edit.editingFinished.connect(lambda: self._update_param_in_config("unsharp_amount", self.unsharp_amount_edit.text(), float))
        self.unsharp_threshold_edit.editingFinished.connect(lambda: self._update_param_in_config("unsharp_threshold", self.unsharp_threshold_edit.text(), int))
        self.unsharp_blur_ksize_edit.editingFinished.connect(lambda: self._update_param_in_config("unsharp_blur_ksize", self.unsharp_blur_ksize_edit.text(), int))
        self.unsharp_blur_sigma_edit.editingFinished.connect(lambda: self._update_param_in_config("unsharp_blur_sigma", self.unsharp_blur_sigma_edit.text(), float))

        # Resize
        self.resize_width_edit.editingFinished.connect(lambda: self._update_param_in_config("resize_width", self.resize_width_edit.text(), int, allow_none_if_zero=True))
        self.resize_height_edit.editingFinished.connect(lambda: self._update_param_in_config("resize_height", self.resize_height_edit.text(), int, allow_none_if_zero=True))
        self.resample_mode_combo.currentTextChanged.connect(lambda text: self._update_param_in_config("resample_mode", text, str))

        # LUT Parameters (corrected connections)
        ...
        self.lut_linear_min_input_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("linear_min_input", self.lut_linear_min_input_edit.text(), int))
        self.lut_linear_max_output_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("linear_max_output", self.lut_linear_max_output_edit.text(), int))
        
        self.lut_gamma_value_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("gamma_value", self.lut_gamma_value_edit.text(), float, slider=self.lut_gamma_value_slider, scale_factor=100.0))
        self.lut_gamma_value_slider.valueChanged.connect(lambda val: self.lut_gamma_value_edit.setText(f"{val / 100.0:.2f}"))

        self.lut_s_curve_contrast_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("s_curve_contrast", self.lut_s_curve_contrast_edit.text(), float, slider=self.lut_s_curve_contrast_slider, scale_factor=100.0))
        self.lut_s_curve_contrast_slider.valueChanged.connect(lambda val: self.lut_s_curve_contrast_edit.setText(f"{val / 100.0:.2f}"))

        self.lut_log_param_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("log_param", self.lut_log_param_edit.text(), float, slider=self.lut_log_param_slider, scale_factor=10.0))
        self.lut_log_param_slider.valueChanged.connect(lambda val: self.lut_log_param_edit.setText(f"{val / 10.0:.1f}"))

        self.lut_exp_param_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("exp_param", self.lut_exp_param_edit.text(), float, slider=self.lut_exp_param_slider, scale_factor=100.0))
        self.lut_exp_param_slider.valueChanged.connect(lambda val: self.lut_exp_param_edit.setText(f"{val / 100.0:.2f}"))

        self.lut_sqrt_param_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("sqrt_param", self.lut_sqrt_param_edit.text(), float))
        self.lut_rodbard_param_edit.editingFinished.connect(lambda: self._update_lut_param_in_config("rodbard_param", self.lut_rodbard_param_edit.text(), float))
    ...
    @Slot(str, str, type, bool)
    def _update_param_in_config(self, param_name: str, text: str, data_type: type, allow_none_if_zero: bool):
        """
        ...
        try:
            ...
            if corrected_value != value_to_set and isinstance(sender_widget, QLineEdit):
                ...
                print(f"DEBUG (UI CORRECTION): {param_name} was corrected by __post_init__ to {corrected_value}. UI updated.")
            ...
            import traceback
            QMessageBox.critical(self, "Internal Error", f"An unexpected error occurred: {e}")
            print(f"DEBUG (CRITICAL ERROR IN _update_param_in_config): {e}\n{traceback.format_exc()}")


    @Slot(str, str, type, QSlider, float)
    def _update_lut_param_in_config(self, param_name: str, text: str, data_type: type, slider: QSlider, scale_factor: float):
        """
        ...
        try:
            ...
            print(f"DEBUG (BEFORE SET): {selected_op.type} op at index {current_row}. Param '{param_name}' current value in config: {getattr(selected_op.lut_params, param_name)}")
            ...
            if corrected_value != value_to_set and isinstance(sender_widget, QLineEdit):
                ...
                sender_widget.blockSignals(False)
            if slider and isinstance(sender_widget, QLineEdit):
                if getattr(selected_op.lut_params, param_name) != value_to_set:
                    slider.blockSignals(True)
                    slider.setValue(int(getattr(selected_op.lut_params, param_name) * scale_factor))
                    slider.blockSignals(False)
            ...
            print(f"DEBUG (AFTER SET): {selected_op.type} op at index {current_row}. Param '{param_name}' **new value in config**: {getattr(selected_op.lut_params, param_name)}")
        
        except Exception as e:
            import traceback
            QMessageBox.critical(self, "Internal Error", f"An unexpected error occurred in LUT update: {e}")
            print(f"DEBUG (CRITICAL ERROR IN _update_lut_param_in_config): {e}\n{traceback.format_exc()}")
    ...
    def _populate_params_widgets(self, op: XYBlendOperation):
        ...
        if op.type == "gaussian_blur":
            ...
            self.lut_generation_type_combo.setCurrentText(op.lut_params.lut_generation_type)
            self._update_lut_gen_type_controls_widget_only(op.lut_params.lut_generation_type)
